...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s castorcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  castorcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded castorcoin transaction") + "\n" +
              "  castorcoin-tx [options] -create [commands]   " + _("Create hex-encoded castorcoin transaction") + "\n" +
              "\n";
