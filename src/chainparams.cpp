...
{
    const char* pszTimestamp = "CAC at 08/Sep/2021 CAC Establishment";
    const CScript genesisOutputScript = CScript() << ParseHex("843754710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1631081353, 2000032558, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3e2c9c7dec29a891a4885c0cd28b4efb6578a355524ff09800ff363bec5dd082"));
        assert(genesis.hashMerkleRoot == uint256S("0xb42974ec807b4feb030f3beec04dc673d0304d9a6a4452b294571b4eefe65d95"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("213.252.245.174", "213.252.245.174", true));
        // vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        // vSeeds.push_back(CDNSSeedData("castorcointools.com", "dnsseed.castorcointools.com"));
        // vSeeds.push_back(CDNSSeedData("castorcoinpool.org", "dnsseed.castorcoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x3e2c9c7dec29a891a4885c0cd28b4efb6578a355524ff09800ff363bec5dd082"))
        ...
        chainTxData = ChainTxData{
            ...
            1631081353, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1631081353, 582894, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xaa2f4f680c572489a3163548da6b028825290a00c138007a5cc9dfdc262b4682"));
        assert(genesis.hashMerkleRoot == uint256S("0xb42974ec807b4feb030f3beec04dc673d0304d9a6a4452b294571b4eefe65d95"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("213.252.245.174", "213.252.245.174"));
        // vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.castorcoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xaa2f4f680c572489a3163548da6b028825290a00c138007a5cc9dfdc262b4682")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1631081353, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x89d164289eabf459df0bb508a411b2ff46075cfd5c2c427c5056b18e22598e68"));
        assert(genesis.hashMerkleRoot == uint256S("0xb42974ec807b4feb030f3beec04dc673d0304d9a6a4452b294571b4eefe65d95"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x89d164289eabf459df0bb508a411b2ff46075cfd5c2c427c5056b18e22598e68"))
        };
