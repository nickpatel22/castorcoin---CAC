...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/castorcoin-project/castorcoin>";
    const std::string URL_WEBSITE = "<https://castorcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Castorcoin version %s\n", FormatFullVersion());
}
